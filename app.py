...
def dashboard():
    galaxies = [
        'Andromeda', 'Triangulum', 'Milky Way', 'Sombrero Galaxy', 'Whirlpool Galaxy', 
        'Cartwheel Galaxy', 'Messier 81', 'Tadpole Galaxy', 'Antennae Galaxies', 
        'Centaurus A', 'Large Magellanic Cloud', 'Small Magellanic Cloud', 'Sculptor Galaxy',
        'Messier 82', 'Hoag’s Object', 'NGC 1300', 'Sunflower Galaxy', 'Messier 87',
        'Pinwheel Galaxy', 'Black Eye Galaxy', 'Black Hole'
    ]
